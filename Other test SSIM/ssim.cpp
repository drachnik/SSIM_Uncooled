...
std::vector<double> read_image(const std::string& filename, int& width, int& height, int& channels) {
...
int main(int argc, char** argv) {
    ...
    try {
        ...
        std::vector<double> img1 = read_image(argv[1], width1, height1, channels1);
        std::vector<double> img2 = read_image(argv[2], width2, height2, channels2);
